...
export const DataPreview: React.FC<Props> = ({ data, }) => {
  ...
  return (
    <div className="data-preview-container mt-6 w-full" style={{ boxSizing: 'border-box' }}>
      ...
      >
        <h4 style={{ fontSize: '18px', fontWeight: 'bold', margin: 0, color: '#10b981', textAlign: 'left' }}>
      ...
      <div className="card-base overflow-hidden border border-white/10 shadow-lg w-full box-border" style={{ borderRadius: '15px' }}>
        <div className="rdg-dark" style={{ height: '240px', width: '100%', boxSizing: 'border-box', fontFamily: "inherit" }} dir={'ltr'}>
           <style>
               {`
                 .rdg-dark .rdg {
