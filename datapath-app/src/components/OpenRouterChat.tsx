          ...
          if (snap.exists()) {
            ...
            if (data.messages) {
              setMessages(data.messages.map((m: Record<string, unknown>) => {
                ...
                if (ts && typeof ts === 'object' && 'toDate' in ts && typeof (ts as Record<string, unknown>).toDate === 'function') {
                  finalDate = (ts as { toDate: () => Date }).toDate();
                } else {
                  finalDate = new Date((ts as string | number) || Date.now());
                }
    ...
    <div className="or-chat-root" dir="rtl">
      ...
      <div className="or-header">
        ...
        <div className="or-header-actions">
          ...
          {/* Model Display (Selector hidden as there is only one model) */}
          <div className="or-model-selector-wrap">
            <div className="or-model-btn-static">
      ...
      <style>{`
        ...
        .or-model-name-short { max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
